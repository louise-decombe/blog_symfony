...
class __TwigTemplate_300e6895b6d3d48d2d1b7a59c717d4725f80a42d5ab9b940fdbd4ec8312846f3 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  131 => 22,  121 => 18,  116 => 16,  111 => 14,  105 => 13,  101 => 12,  97 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<article>
<h2>{{ article.title }}</h2>
<div classe=\"metadata\">Ecrit le {{ article.createdAt | date('d/m/y') }} à {{ article.createdAt | date('H:i') }} catégorie coding</div>
<img src=\"{{ article.image }}\" alt=\"\">
<p>
{{ article.content | raw }}
</p>
<a href=\"{{ path('blog_show') }}\" class=\"btn btn-primary\">Lire la suite</a></div>
</div>
</article>
{% endfor %}
...
", "blog/index.html.twig", "/home/marie-madeleine/test/templates/blog/index.html.twig");
    }
}
